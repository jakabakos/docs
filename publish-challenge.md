...
6. Since the master branch is write-protected, only the staging branch can be used later on.
7. Use the correct challenge template from our [challenge toolbox](https://github.com/avatao-content/challenge-toolbox) and copy all the necessary information \(excluding .git directory\) from there to the git repository you have just cloned.
